  ...
  return (
    <ResponsiveContainer width="100%" height={260}>
      <ComposedChart data={data} margin={{ top: 10, right: 10, left: -10, bottom: 0 }}>
        ...
        <Area yAxisId="left" type="monotone" dataKey="volume" stroke="#22D3EE" strokeWidth={1.5} fill="url(#volumeGrad)" />
        <Line yAxisId="right" type="monotone" dataKey="fraud_rate_pct" stroke="#FB923C" strokeWidth={1.75} dot={false} />
      </ComposedChart>
    </ResponsiveContainer>
  );
}
